...
(
    ...
    vertexOut.position = frameConstants.projectionMatrix * frameConstants.viewMatrix * instanceData[instanceId].modelMatrix * position;
    ...
    vertexOut.tangentLightVector = TBN * normalize(frameConstants.lightVector);
